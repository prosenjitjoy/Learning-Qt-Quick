    ...
    : QAbstractListModel{parent}
{
    ...
    addAudio("Eine Kleine Nachtmusik",
             ...
             QUrl("qrc:/QtModelViewController/assets/audios/eine.mp3"),
             QUrl("qrc:/QtModelViewController/assets/images/eine.jpeg"));

    addAudio("Symphony No. 5",
             "Ludwig Van Beethoven",
             QUrl("qrc:/QtModelViewController/assets/audios/symphony.mp3"),
             QUrl("qrc:/QtModelViewController/assets/images/symphony.jpeg"));

    addAudio("Air on the G String",
             "Johann Sebastian Bach",
             QUrl("qrc:/QtModelViewController/assets/audios/air.mp3"),
             QUrl("qrc:/QtModelViewController/assets/images/air.jpeg"));
}
